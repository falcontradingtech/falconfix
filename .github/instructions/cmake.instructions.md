...
- Presets: `windows-debug|windows-release|linux-debug|linux-release` (configure, build, test). Never create ad-hoc build dirs. If `build/<preset>` already exists, reuse it and build incrementally — don't reconfigure or wipe it.
