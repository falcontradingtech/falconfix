...
class InstrmtGrpComponentTest : public ::testing::Test {
protected:
...
TEST_F(InstrmtGrpComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(InstrmtGrpComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
    
}

TEST_F(InstrmtGrpComponentTest, EncodeDecodeRoundtrip) {
    char buffer[50];
...
TEST_F(InstrmtGrpComponentTest, CheckRequiredWhenEmpty) {
