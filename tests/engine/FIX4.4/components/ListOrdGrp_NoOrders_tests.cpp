...
class ListOrdGrp_NoOrdersComponentTest : public ::testing::Test {
protected:
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetListSeqNoAndListSeqNoMatch) {
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetSettlInstModeAndSettlInstModeMatch) {
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetTradeOriginationDateAndTradeOriginationDateMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetTradeDateAndTradeDateMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetAcctIDSourceAndAcctIDSourceMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetAccountTypeAndAccountTypeMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetDayBookingInstAndDayBookingInstMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetBookingUnitAndBookingUnitMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetPreallocMethodAndPreallocMethodMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetSettlTypeAndSettlTypeMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetSettlDateAndSettlDateMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetCashMarginAndCashMarginMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetHandlInstAndHandlInstMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetMinQtyAndMinQtyMatch) {
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetMaxFloorAndMaxFloorMatch) {
    const double test_value = 123.456;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetProcessCodeAndProcessCodeMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetPrevClosePxAndPrevClosePxMatch) {
    const double test_value = 123.456;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetSideAndSideMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetSideValueIndAndSideValueIndMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetLocateReqdAndLocateReqdMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetTransactTimeAndTransactTimeMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetQtyTypeAndQtyTypeMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetOrdTypeAndOrdTypeMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetPriceTypeAndPriceTypeMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetPriceAndPriceMatch) {
    const double test_value = 123.456;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetStopPxAndStopPxMatch) {
    const double test_value = 123.456;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetSolicitedFlagAndSolicitedFlagMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetTimeInForceAndTimeInForceMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetEffectiveTimeAndEffectiveTimeMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetExpireDateAndExpireDateMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetExpireTimeAndExpireTimeMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetGTBookingInstAndGTBookingInstMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetOrderCapacityAndOrderCapacityMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetCustOrderCapacityAndCustOrderCapacityMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetForexReqAndForexReqMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetBookingTypeAndBookingTypeMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetEncodedTextLenAndEncodedTextLenMatch) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetSettlDate2AndSettlDate2Match) {
}

TEST_F(ListOrdGrp_NoOrdersComponentTest, SetOrderQty2AndOrderQty2Match) {
    const double test_value = 123.456;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetPrice2AndPrice2Match) {
    const double test_value = 123.456;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetPositionEffectAndPositionEffectMatch) {
    const char test_value = 'X';
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetCoveredOrUncoveredAndCoveredOrUncoveredMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetMaxShowAndMaxShowMatch) {
    const double test_value = 123.456;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetTargetStrategyAndTargetStrategyMatch) {
    const int64_t test_value = 12345;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, SetParticipationRateAndParticipationRateMatch) {
    const double test_value = 123.456;
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, EncodeDecodeRoundtrip) {
    char buffer[2866];
...
TEST_F(ListOrdGrp_NoOrdersComponentTest, CheckRequiredWhenEmpty) {
