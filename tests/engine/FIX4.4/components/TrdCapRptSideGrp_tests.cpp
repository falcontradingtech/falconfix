...
// Component: TrdCapRptSideGrp (FIX4.4)
...
class TrdCapRptSideGrpComponentTest : public ::testing::Test {
protected:
...
TEST_F(TrdCapRptSideGrpComponentTest, ResetClearsAllFields) {
    // Set some fields
    component.setSide('A');
...
TEST_F(TrdCapRptSideGrpComponentTest, SetSideAndSideMatch) {
...
TEST_F(TrdCapRptSideGrpComponentTest, SetAcctIDSourceAndAcctIDSourceMatch) {
...
TEST_F(TrdCapRptSideGrpComponentTest, SetAccountTypeAndAccountTypeMatch) {
    const int64_t test_value = 12345;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetProcessCodeAndProcessCodeMatch) {
    const char test_value = 'X';
...
TEST_F(TrdCapRptSideGrpComponentTest, SetOddLotAndOddLotMatch) {
}

TEST_F(TrdCapRptSideGrpComponentTest, SetSolicitedFlagAndSolicitedFlagMatch) {
}

TEST_F(TrdCapRptSideGrpComponentTest, SetOrderCapacityAndOrderCapacityMatch) {
    const char test_value = 'X';
...
TEST_F(TrdCapRptSideGrpComponentTest, SetCustOrderCapacityAndCustOrderCapacityMatch) {
    const int64_t test_value = 12345;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetOrdTypeAndOrdTypeMatch) {
    const char test_value = 'X';
...
TEST_F(TrdCapRptSideGrpComponentTest, SetTransBkdTimeAndTransBkdTimeMatch) {
}

TEST_F(TrdCapRptSideGrpComponentTest, SetGrossTradeAmtAndGrossTradeAmtMatch) {
...
TEST_F(TrdCapRptSideGrpComponentTest, SetNumDaysInterestAndNumDaysInterestMatch) {
    const int64_t test_value = 12345;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetExDateAndExDateMatch) {
}

TEST_F(TrdCapRptSideGrpComponentTest, SetAccruedInterestRateAndAccruedInterestRateMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetAccruedInterestAmtAndAccruedInterestAmtMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetInterestAtMaturityAndInterestAtMaturityMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetEndAccruedInterestAmtAndEndAccruedInterestAmtMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetStartCashAndStartCashMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetEndCashAndEndCashMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetConcessionAndConcessionMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetTotalTakedownAndTotalTakedownMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetNetMoneyAndNetMoneyMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetSettlCurrAmtAndSettlCurrAmtMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetSettlCurrFxRateAndSettlCurrFxRateMatch) {
    const double test_value = 123.456;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetSettlCurrFxRateCalcAndSettlCurrFxRateCalcMatch) {
    const char test_value = 'X';
...
TEST_F(TrdCapRptSideGrpComponentTest, SetPositionEffectAndPositionEffectMatch) {
    const char test_value = 'X';
...
TEST_F(TrdCapRptSideGrpComponentTest, SetEncodedTextLenAndEncodedTextLenMatch) {
}

TEST_F(TrdCapRptSideGrpComponentTest, SetSideMultiLegReportingTypeAndSideMultiLegReportingTypeMatch) {
    const int64_t test_value = 12345;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetTradeAllocIndicatorAndTradeAllocIndicatorMatch) {
    const int64_t test_value = 12345;
...
TEST_F(TrdCapRptSideGrpComponentTest, SetPreallocMethodAndPreallocMethodMatch) {
    const char test_value = 'X';
...
TEST_F(TrdCapRptSideGrpComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
...
TEST_F(TrdCapRptSideGrpComponentTest, EncodeDecodeRoundtrip) {
    char buffer[2752];
    ...
    // Decode back
    TrdCapRptSideGrp decoded;
    const char *q = buffer;
    bool decode_result = decoded.decode(q, p);
    EXPECT_TRUE(decode_result);
}

TEST_F(TrdCapRptSideGrpComponentTest, CheckRequiredWhenEmpty) {
