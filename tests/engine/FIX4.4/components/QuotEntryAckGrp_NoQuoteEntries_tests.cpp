...
class QuotEntryAckGrp_NoQuoteEntriesComponentTest : public ::testing::Test {
protected:
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetBidPxAndBidPxMatch) {
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetOfferPxAndOfferPxMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetBidSizeAndBidSizeMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetOfferSizeAndOfferSizeMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetValidUntilTimeAndValidUntilTimeMatch) {
}

TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetBidSpotRateAndBidSpotRateMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetOfferSpotRateAndOfferSpotRateMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetBidForwardPointsAndBidForwardPointsMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetOfferForwardPointsAndOfferForwardPointsMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetMidPxAndMidPxMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetBidYieldAndBidYieldMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetMidYieldAndMidYieldMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetOfferYieldAndOfferYieldMatch) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetTransactTimeAndTransactTimeMatch) {
}

TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetSettlDateAndSettlDateMatch) {
}

TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetOrdTypeAndOrdTypeMatch) {
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetSettlDate2AndSettlDate2Match) {
}

TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetOrderQty2AndOrderQty2Match) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetBidForwardPoints2AndBidForwardPoints2Match) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetOfferForwardPoints2AndOfferForwardPoints2Match) {
    const double test_value = 123.456;
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, SetQuoteEntryRejectReasonAndQuoteEntryRejectReasonMatch) {
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, EncodeDecodeRoundtrip) {
    char buffer[1358];
...
TEST_F(QuotEntryAckGrp_NoQuoteEntriesComponentTest, CheckRequiredWhenEmpty) {
