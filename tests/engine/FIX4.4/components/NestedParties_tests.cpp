...
// Component: NestedParties (FIX4.4)
...
TEST_F(NestedPartiesComponentTest, SetNestedPartyIDSourceAndNestedPartyIDSourceMatch) {
...
TEST_F(NestedPartiesComponentTest, SetNestedPartyRoleAndNestedPartyRoleMatch) {
