...
class FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest : public ::testing::Test {
protected:
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetBidPxAndBidPxMatch) {
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetOfferPxAndOfferPxMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetBidSizeAndBidSizeMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetOfferSizeAndOfferSizeMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetValidUntilTimeAndValidUntilTimeMatch) {
}

TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetBidSpotRateAndBidSpotRateMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetOfferSpotRateAndOfferSpotRateMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetBidForwardPointsAndBidForwardPointsMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetOfferForwardPointsAndOfferForwardPointsMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetMidPxAndMidPxMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetBidYieldAndBidYieldMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetMidYieldAndMidYieldMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetOfferYieldAndOfferYieldMatch) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetTransactTimeAndTransactTimeMatch) {
}

TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetSettlDateAndSettlDateMatch) {
}

TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetOrdTypeAndOrdTypeMatch) {
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetSettlDate2AndSettlDate2Match) {
}

TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetOrderQty2AndOrderQty2Match) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetBidForwardPoints2AndBidForwardPoints2Match) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, SetOfferForwardPoints2AndOfferForwardPoints2Match) {
    const double test_value = 123.456;
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, EncodeDecodeRoundtrip) {
    char buffer[1308];
...
TEST_F(FIX4_4_QuotEntryGrp_NoQuoteEntriesComponentTest, CheckRequiredWhenEmpty) {
