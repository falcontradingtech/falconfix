...
class FIX4_4_NestedParties2ComponentTest : public ::testing::Test {
protected:
...
TEST_F(FIX4_4_NestedParties2ComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(FIX4_4_NestedParties2ComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
    
}

TEST_F(FIX4_4_NestedParties2ComponentTest, EncodeDecodeRoundtrip) {
    char buffer[50];
...
TEST_F(FIX4_4_NestedParties2ComponentTest, CheckRequiredWhenEmpty) {
