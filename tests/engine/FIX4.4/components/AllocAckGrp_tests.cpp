...
class FIX4_4_AllocAckGrpComponentTest : public ::testing::Test {
protected:
...
TEST_F(FIX4_4_AllocAckGrpComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(FIX4_4_AllocAckGrpComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
    
}

TEST_F(FIX4_4_AllocAckGrpComponentTest, EncodeDecodeRoundtrip) {
    char buffer[48];
...
TEST_F(FIX4_4_AllocAckGrpComponentTest, CheckRequiredWhenEmpty) {
