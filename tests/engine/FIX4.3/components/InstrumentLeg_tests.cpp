...
// Component: InstrumentLeg (FIX4.3)
...
class FIX4_3_InstrumentLegComponentTest : public ::testing::Test {
protected:
...
TEST_F(FIX4_3_InstrumentLegComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(FIX4_3_InstrumentLegComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
    
}

TEST_F(FIX4_3_InstrumentLegComponentTest, EncodeDecodeRoundtrip) {
    char buffer[50];
...
TEST_F(FIX4_3_InstrumentLegComponentTest, CheckRequiredWhenEmpty) {
