...
// Component: UnderlyingInstrument (FIX4.3)
...
class FIX4_3_UnderlyingInstrumentComponentTest : public ::testing::Test {
protected:
...
TEST_F(FIX4_3_UnderlyingInstrumentComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(FIX4_3_UnderlyingInstrumentComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
    
}

TEST_F(FIX4_3_UnderlyingInstrumentComponentTest, EncodeDecodeRoundtrip) {
    char buffer[50];
...
TEST_F(FIX4_3_UnderlyingInstrumentComponentTest, CheckRequiredWhenEmpty) {
