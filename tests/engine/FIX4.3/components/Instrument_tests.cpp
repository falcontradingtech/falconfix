...
class FIX4_3_InstrumentComponentTest : public ::testing::Test {
protected:
...
TEST_F(FIX4_3_InstrumentComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(FIX4_3_InstrumentComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
    
}

TEST_F(FIX4_3_InstrumentComponentTest, EncodeDecodeRoundtrip) {
    char buffer[50];
...
TEST_F(FIX4_3_InstrumentComponentTest, CheckRequiredWhenEmpty) {
