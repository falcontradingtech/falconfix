...
class FIX4_3_PartiesComponentTest : public ::testing::Test {
protected:
    Parties component;
...
TEST_F(FIX4_3_PartiesComponentTest, ResetClearsAllFields) {
    // Set some fields
...
TEST_F(FIX4_3_PartiesComponentTest, HasAnySetTracksPresence) {
    EXPECT_FALSE(component.hasAnySet());
    
}

TEST_F(FIX4_3_PartiesComponentTest, EncodeDecodeRoundtrip) {
    char buffer[50];
...
TEST_F(FIX4_3_PartiesComponentTest, CheckRequiredWhenEmpty) {
